...
return [
    ...
    */
    'attributes' => [
        ...
        'customer_id' => "شناسه بیمار",
        'sampling_package_id' => 'شناسه تست',
        'address_id' => 'شناسه آدرس',
        'prescription_image' => 'تصویر نسخه',
        'suggested_datetime' => 'تاریخ و زمان پیشنهادی',
        'insurance_id' => 'شناسه بیمه',
        'extra_insurance_id' => 'شناسه بیمه تکمیلی',
        "tag" => "تگ",
        "transport_return_cost" => "هزینه برگشت",
        "transport_departure_cost" => "هزینه رفت",
        "transport_method" => "روش ایاب و ذهاب",
        'note' => "یادداشت",
        'voice' => 'پیام صوتی',
        "receipt_lab_name" => "نام آزمایشگاه",
        "receipt_delivery_date" => "تاریخ تحویل",
        "receipt_picture" => "تصویر رسید آزمایشگاه",
        'fixed_datetime' => 'تاریخ و ساعت',
        'sampler_id' => 'نمونه گیر',
        'lab_id' => 'آزمایشگاه',
        'subject' => 'عنوان',
        'payment_method' => 'روش پرداخت',
        'result_path' => 'فایل پاسخ',
        'link' => 'لینک',
        ...
        'national_card_picture' => 'تصویر کارت ملی',
        'time_interval_id' => 'بازه زمانی انتخاب شده',
        'suggested_date' => 'تاریخ انتخاب شده',
        'referral_code' => 'کد معرف',
        'question_id' => 'پرسش',
        'option_id' => 'گزینه',
        'related_person_id' => 'شخص وابسته',
        'second_phone' => 'سایر تلفن ها',
        'second_address' => 'سایر آدرس ها',
    ],
];
