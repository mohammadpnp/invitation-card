          ...
          <div class="content-wrapper">
            ...
            <div class="container-fluid  flex-grow-1 container-p-y">
              ...
              <!-- Edit User -->
                    ...
                    <form action="{{route('fairs.update',$fair->id)}}" enctype="multipart/form-data" method="post" class="row g-3" >
                        @csrf
                        @method('PATCH')
                        <div class="button-wrapper">
                                    ...
                                    <p class="mb-0">فایل‌های png و jpg مجاز هستند. حداکثر اندازه فایل 1024KB.</p>
                                          ...
                                          <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" value="{{old('name') ?? $fair->name}}"  name="name" class="form-control">
                                          </div>
                                          <div class="col-12 col-md-6">
                                            <label class="form-label" for="modalEditUserFirstName">مکان</label>
                                            <input type="text" value="{{old('place') ?? $fair->place}}"  name="place" class="form-control">
                                          </div>
                                          <div class="col-12 col-md-6">
                                            <label class="form-label" for="modalEditUserFirstName">شهر</label>
                                            <input type="text" value="{{old('city') ?? $fair->city}}"  name="city" class="form-control">
                                          </div>
                                          <div class="col-12 col-md-6">
                                            <label class="form-label" for="modalEditUserFirstName">عنوان</label>
                                            <input type="text" value="{{old('title') ?? $fair->title}}"  name="title" class="form-control">
                                          </div>
                                          <div class="col-12 col-md-6">
                                            <label class="form-label" for="modalEditUserFirstName">سالن</label>
                                            <input type="text" value="{{old('salon') ?? $fair->salon}}"  name="salon" class="form-control">
                                          </div>
                                          <div class="col-12 col-md-6">
                                            <label class="form-label" for="modalEditUserFirstName">ارائه دهنده</label>
                                            <input type="text" value="{{old('presenter') ?? $fair->presenter}}"  name="presenter" class="form-control">
                                          </div>
                                          <div class="col-12 col-md-6">
                                            <label class="form-label">تاریخ شروع</label>
                                            <input type="date" class="form-control" value="{{ \Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse(old('start_date_at') ?? $fair->start_date_at))->format('Y/m/d h')}}" name="start_date_at" id="flatpickr-date">
                                          ...
                                          <div class="col-12 col-md-6">
                                            ...
                                            <input type="date" class="form-control" value="{{\Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse(old('end_date_at') ?? $fair->end_date_at))->format('Y/m/d h')}}" name="end_date_at" id="flatpickr-date">
                                            <span style="opacity: 0;height:1px;display: block">++2022-09-09++</span>
                                            {{--This item use for set width's of input automatically --}}
                                          </div>
                                          <div class="col-12">
                                ...
                                <input type="hidden" name="id" value="{{$fairPlace->id}}">
