<!DOCTYPE html>
<html lang="fa" class="light-style layout-fair-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-fair">
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="datatables-basic table table-bordered">
                                ...
                                @foreach($fairs as $fair)
                                    <tr class="text-center">
                                        <td>
                                            <span class="fw-semibold">{{$fair->id}}</span>
                                        </td>
                                        ...
                                        <td>
                                            <img src="{{$fair['start_date_at'] == null ? '' : \Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse($fair['start_date_at']))->format('Y/m/d - H')}}">
                                        </td>

                                        <td>
                                            <img src="{{$fair['end_date_at'] == null ? '' : \Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse($fair['end_date_at']))->format('Y/m/d - H')}}">
                                        </td>

                                        <td>
                                            <span class="fw-semibold">{{ $fair->fair_place_id }}</span>
                                        </td>

                                        <td>
                                            <span class="fw-semibold">{{$fair->description}}</span>
                                        </td>

                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{route('fairs.edit',$fair->id)}}" class="btn btn-sm btn-icon">
