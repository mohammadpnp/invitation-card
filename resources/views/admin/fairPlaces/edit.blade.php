          ...
          <div class="content-wrapper">
            ...
            <div class="container-fluid  flex-grow-1 container-p-y">
              ...
              <!-- Edit User -->
                    ...
                    <form action="{{route('fairPlaces.update',$fairPlace->id)}}" enctype="multipart/form-data" method="post" class="row g-3" >
                        @csrf
                        @method('PATCH')
                        <div class="button-wrapper">

                                    <div class="d-flex">
                                      <img src="{{ $fairPlace->poster }}" alt="">
                                ...
                                <div class="col-12 col-md-6">
                                  ...
                                  <input type="text" value="{{old('name') ?? $fairPlace->name}}"  name="name" class="form-control">
                                </div>
                                <div class="col-12 col-md-6">
                                  <div>
                                    <label class="form-label" for="internal">داخلی</label>
                                    <input type="radio" id="internal" value="1"  name="is_internal" class="">
                                  </div>
                                  <div>
                                    <label class="form-label" for="foreign">خارجی</label>
                                    <input type="radio" value="0" id="foreign" name="is_internal" class="">
                                  </div>
                                </div>
                                <div class="col-12">
                                  <label class="form-label" for="modalEditUserFirstName">لینک</label>
                                  <textarea name="description" class="form-control">{{old('description') ?? $fairPlace->description}}</textarea>
                                </div>
