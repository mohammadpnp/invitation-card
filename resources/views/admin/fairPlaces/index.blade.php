                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="datatables-basic table table-bordered">
                                ...
                                @foreach($fairPlaces as $fairPlace)
                                    <tr class="text-center">
                                        <td>
                                            <span class="fw-semibold">{{$fairPlace->id}}</span>
                                        </td>

                                        <td>
                                            <img src="{{ $fairPlace->name }}">
                                        </td>

                                        <td>
                                            <span class="fw-semibold">@if($fairPlace->is_internal == 1) داخلی @else خارجی @endif</span>
                                        </td>

                                        <td>
                                            <span class="fw-semibold">{{$fairPlace->description}}</span>
                                        </td>

                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{route('fairPlaces.edit',$fairPlace->id)}}" class="btn btn-sm btn-icon">
