                    ...
                    <form action="{{route('users.update',$user->id)}}" method="post" class="row g-3" >
                        ...
                        @method('PATCH')
                                  ...
                                  <div class="col-12 col-md-6">
                                      ...
                                      <input type="text" value="{{$user->mobile}}"  name="mobile" class="form-control text-start" dir="ltr">
                                  </div>
                                  <div class="col-12 col-md-6">
            ...
            {{--Edit password--}}
              <div class="container-xxl flex-grow-1 container-p-y">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.users.password', $user)}}" class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                            @csrf
                            @method('POST')
                            <div class="row">
