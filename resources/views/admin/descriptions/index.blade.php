                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="datatables-basic table table-bordered">
                                ...
                                @foreach($descriptions as $description)
                                    <tr class="text-center">
                                        <td>
                                            <span class="fw-semibold">{{$description->id}}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{route('descriptions.edit',$description->id)}}" class="btn btn-sm btn-icon">
                        ...
                        <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                            <div class="modal-content p-3 p-md-5">
                                <div class="modal-body">
                                    ...
                                    <form action="{{route('descriptions.store')}}" method="post" class="row g-3" enctype="multipart/form-data">
                                        @csrf
