...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, description-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-fluid  flex-grow-1 container-p-y">
              ...
              <!-- Edit User -->
                    ...
                    <form action="{{route('descriptions.store')}}" method="post" class="row g-3" >
                        @csrf
                        @method('POST')
                                  <div class="col-12">
                                      <label class="form-label" for="modalEditUserFirstName">نوع</label>
                                      <select type="text" value="{{old('type')}}"  name="type" class="form-control">
                                        <option value="1">سر صفحه</option>
                                        <option value="2">بخش اصلی</option>
                                        <option value="3">پا صفحه</option>
                                      </select>
                                  </div>
                                  <div class="col-12">
...
{{--    <script src="{{asset('/assets/js/tables-datatables-extensions.js')}}"></script>--}}
    <script src="{{asset('/assets/js/modal-edit-description.js')}}"></script>
