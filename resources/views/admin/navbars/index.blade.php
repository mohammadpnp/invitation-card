                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="datatables-basic table table-bordered">
                                ...
                                @foreach($navbars as $navbar)
                                    <tr class="text-center">
                                        <td>
                                            <span class="fw-semibold">{{$navbar->id}}</span>
                                        </td>

                                        <td>
                                            <img src="{{ $navbar->icon }}" class="">
                                        </td>

                                        <td>
                                            <span class="fw-semibold">{{$navbar->title}}</span>
                                        </td>

                                        <td>
                                            <span class="fw-semibold">{{$navbar->link}}</span>
                                        </td>

                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{route('navbars.edit',$navbar->id)}}" class="btn btn-sm btn-icon">
