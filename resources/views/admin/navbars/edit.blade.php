          ...
          <div class="content-wrapper">
            ...
            <div class="container-fluid  flex-grow-1 container-p-y">
              ...
              <!-- Edit User -->
                    ...
                    <form action="{{route('navbars.update',$navbar->id)}}" enctype="multipart/form-data" method="post" class="row g-3" >
                        @csrf
                        @method('PATCH')
                        <div class="button-wrapper">
                                ...
                                <div class="col-12 col-md-6">
                                  ...
                                  <input type="text" value="{{old('title') ?? $navbar->title}}"  name="title" class="form-control">
                                </div>
                                <div class="col-12 col-md-6">
                                  <label class="form-label" for="modalEditUserFirstName">لینک</label>
                                  <input type="text" value="{{old('link') ?? $navbar->link}}"  name="link" class="form-control">
                                </div>
