...
{{--                          <a href="javascript:void(0)" class="dropdown-notifications-all text-body" data-bs-toggle="tooltip" data-bs-placement="top" title="علامت خوانده شده به همه"><i class="bx fs-4 bx-envelope-open"></i></a>--}}
{{--                        </div>--}}
{{--                      </li>--}}
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a class="dropdown-item" href="#">
                          <div class="d-flex">
                            <div class="flex-grow-1">
                              <span class="fw-semibold d-block">{{Auth::guard('user')->user()->first_name.' '.Auth::guard('user')->user()->last_name}}</span>
                              <small>مدیر</small>
                            </div>
                          </div>
                        </a>
                      ...
                      <li>
                        <a data-bs-toggle="modal" data-bs-target="#logoutModal" class="dropdown-item">
