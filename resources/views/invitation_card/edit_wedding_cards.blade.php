            ...
            <div class="content-wrapper">
                ...
                <div class="container-fluid  flex-grow-1 container-p-y">
                    ...
                    <div class="card p-3">
                        ...
                        <div class=" mb-4">
                            <h3 class="text-center secondary-font">اپدیت کارت دعوت</h3>
                        </div>
                        @if ($errors->any())
                        ...
                        @endif
                    <div class="d-flex">
                        <form action="{{route('invitation-card.update.wedding',$card->id)}}" method="post" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserStatus">عکس سرتیتر</label>
                                <input class="form-control" type="file" name="header_picture">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="modalEditUserStatus">آیا نظرسنجی و یادداشت نیاز است؟</label>
                                <select name="have_survey" class="form-select">
                                    <option {{$card->card->have_survey === 1 ? 'selected' : ''}} value="1">بله</option>
                                    <option {{$card->card->have_survey === 0 ? 'selected' : ''}} value="0">خیر</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <label class="form-label" for="modalEditTaxID">متن اصلی</label>
                                <textarea class="form-control" name="description" cols="30" rows="10">{{$card->card->description}}</textarea>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="hidden" name="lat" id="lat" value="{{$card->card->lat}}">
                                <input type="hidden" name="lng" id="lng" value="{{$card->card->lng}}">
                            </div>
