            ...
            <div class="content-wrapper">
                ...
                <div class="container-fluid  flex-grow-1 container-p-y">
                    ...
                    <div class="card p-3">
                        ...
                        <div class=" mb-4">
                            <h3 class="text-center secondary-font">ساخت کارت دعوت کاغذی</h3>
                        </div>
                        @if ($errors->any())
                        ...
                        @endif
                    <div class="d-flex">
                        <form action="{{route('invitation-card.store.paper')}}" method="post"  class="row g-3">
                            @csrf
                            @method('POST')
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <select  name="gender" class="form-select" >
                                    <option  value="{{\App\Models\PaperCard::MAN_GENDER}}">آقا</option>
                                    <option  value="{{\App\Models\PaperCard::WOMAN_GENDER}}">خانم</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="text" cols="30" rows="10">{{old('text')}}</textarea>
                            </div>
